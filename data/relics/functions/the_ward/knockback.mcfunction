...
execute if score x2 temp matches 1.. run scoreboard players add velocity temp 200
execute if score x2 temp matches ..-1 run scoreboard players remove velocity temp 200
...
execute if score y2 temp matches 0.. run scoreboard players add velocity temp 100
execute if score y2 temp matches ..-1 run scoreboard players remove velocity temp 100
...
execute if score z2 temp matches 1.. run scoreboard players add velocity temp 200
execute if score z2 temp matches ..-1 run scoreboard players remove velocity temp 200
